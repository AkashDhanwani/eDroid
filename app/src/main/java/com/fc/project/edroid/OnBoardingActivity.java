...
public class OnBoardingActivity extends AhoyOnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AhoyOnboarderCard card1=new AhoyOnboarderCard("Welcome User!","We are thrilled to have you on our service.", R.drawable.logo);
       ...
       // AhoyOnboarderCard card3=new AhoyOnboarderCard("Bookmark","Bookmark your products to keep a track on them.", R.drawable.bookmark);
        AhoyOnboarderCard card4=new AhoyOnboarderCard("A little reminder","Always keep your wifi on and now you are all set to go :)", R.drawable.wfi);
